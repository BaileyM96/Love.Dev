...
//Bio form needs to be the last input field 
    //The continue button needs to have the handleformSubmit submit button

export default function BioForm({formData, handleInputChange, previousPage, handleFormSubmit}) {
        ...
        <LandingContainer>
          ...
          <>
            ...
            <ContinueBack>
                ...
                <Continue onClick={handleFormSubmit}>Create</Continue>
            </ContinueBack>
            </InputContainer>
