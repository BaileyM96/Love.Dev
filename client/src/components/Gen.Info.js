...
import { LandingContainer, InputContainer, ContinueBack } from "./styles/container.styled";
import { Text } from "./styles/Header.styled";
import Input from './styles/genericInput.styled';
import { Gender, Back, Continue } from "./styles/Buttons.styled"
//Ensures the api is properly loaded and proviedes suggested locations
import { LoadScript, Autocomplete } from '@react-google-maps/api';
 

export default function Info({ formData, handleInputChange, nextPage, handleGenderButton }) {
    ...
    const handlePlaceSelect = () => {
      if (autocompleteRef.current) {
        ...
        handleInputChange({ target: { name: 'location', value: location } });
      }
    }
    ...
    //Need to add google maps API to the return statement
    //Find out how to access your api keys and if google maps is free
    return (
        <LandingContainer>
            <svg 
        ...
        <Input 
          ...
          <ContinueBack>
            <Back onClick={handleBackToLogin}>Back</Back>
            <Continue onClick={nextPage}>Continue</Continue>
          </ContinueBack>
        </InputContainer>
