import { LandingContainer, InputContainer, ContinueBack, Span } from "./styles/container.styled";
import { Text } from "./styles/Header.styled";
import Input from './styles/genericInput.styled';
import { Back, Continue } from "./styles/Buttons.styled";

export default function Interests({formData, handleInputChange, previousPage, nextPage}) {
    return (
        <LandingContainer>
        <svg 
          ...
          <>
        <InputContainer>
        <Text>Favorite Coding Language</Text>
        <Input 
        type="text"
        name="language"
        ...
        {/* Later make this field a dropdown menu */}
        ...
        <Text>Hobbies<Span> (seperate with comma)</Span></Text>
        <Input 
        type="text"
        name="hobbies"
        ...
        />
          ...
          <ContinueBack>
            <Back onClick={previousPage}>Back</Back>
